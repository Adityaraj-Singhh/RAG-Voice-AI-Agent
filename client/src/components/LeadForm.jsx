...
const LeadForm = ({ onSuccess }) => {
  ...
  return (
    <form 
      ...
      className="bg-white rounded-3xl shadow-card-lg p-5 sm:p-8 md:p-10 max-w-xl mx-auto animate-slide-up border border-gray-100"
      noValidate
    >
      {/* Header with gradient accent */}
      <div className="relative text-center mb-8">
        <div className="absolute -top-8 sm:-top-10 left-1/2 transform -translate-x-1/2">
          <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-primary-500 to-primary-700 rounded-2xl flex items-center justify-center shadow-lg rotate-3">
      ...
      <div className="space-y-6">
        ...
        {/* Trust Badges */}
        <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4 mt-6 pt-6 border-t border-gray-100">
